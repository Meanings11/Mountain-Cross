...
public class EndingClick3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // dialogues
        string[] lines = {"Kidnapper:I think I'm falling in love with you.\nDo you two want to stay with me\nand leave the game, or keep playing?", "Groom:I wanna..."};
        /* better to use json */
