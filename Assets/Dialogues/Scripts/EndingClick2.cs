...
public class EndingClick2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // dialogues
        string[] lines = {"Kidnapper:Do you want to escape with your\nbride now, or keep playing so that\nI can give you some other options?", "Groom:I wanna..."};
        /* better to use json */
