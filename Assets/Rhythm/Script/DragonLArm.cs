...
public class DragonLArm : MonoBehaviour {
	...
	void BeatTrigger(){
		if ((rhythm.BeatTrigger == true) && (beatCountdown == 1) && rhythm.armSelect == 1) {
	...
	void Return(){
		...
		if (GoingBackCooldown <= 0f){
			...
			//GoingBackCooldown = GoingBackCooldownSet;
				...
				if ((beatCountdown == 2) && (Smash == true) && rhythm.armSelect == 1) {
